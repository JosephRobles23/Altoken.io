...
export function SignUpDialog({ isOpen, onClose, onSwitchToSignIn }: SignUpDialogProps) {
  ...
  const modalContent = (
    ...
    >
      <div
        className="relative w-full max-w-md bg-background rounded-2xl shadow-xl p-8 my-8"
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">Únete a Altoken y comienza a invertir</p>
        </div>
